        ...
        return(
            <div className="container-fluid"><br/>
               <div className="row sideNavLink" align="center">
                 <a href="https://nodaddy.github.io/Foreign-Research-Portal/projects" id="projects" className="col-sm-12">Projects</a>
                 </div>
                <div className="row sideNavLink" align="center">
                    <a href="https://nodaddy.github.io/Foreign-Research-Portal/yourapplications"  id="yourApplications" className="col-sm-12">Your Applications</a>
                 </div>
                 <div className="row sideNavLink" align="center">
